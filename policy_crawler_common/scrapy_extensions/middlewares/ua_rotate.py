...
class RandomUserAgent(UserAgentMiddleware):
    ...
    def __init__(self, settings):
        ...
        if ua_type == 'MOBILE':
            USER_AGENTS = self.USER_AGENTS_OF_MOBILE
        else:
    ...
    USER_AGENTS_OF_PC = [ 'Mozilla/4.0 (compatible; MSIE 7.0; Windows NT 6.0; Acoo Browser; SLCC1; .NET CLR 2.0.50727; Media Center PC 5.0; .NET CLR 3.0.04506)', 'Opera/9.80 (Macintosh; Intel Mac OS X 10.6.8; U; fr) Presto/2.9.168 Version/11.52Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Ubuntu Chromium/50.0.2661.102 Chrome/50.0.2661.102 Safari/537.36',
